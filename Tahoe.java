...
public class Tahoe extends SUV{
	...
	public Tahoe(String CompMake, String TypeCar, String CarModel, double Price, double miles, String Color)
	{
	...
	public void Report() 
	{
		System.out.println("\t" +"The price of our "  +  model + "s start at " + /*get lowest*/ price +". " + model + "s are spacious and are considered light trucks." );
	}

	
	
	
	public void TahoeMethod()
	{
		System.out.println("\t" + model +  " is a 4 wheel drive SUV. They are available in gold and black. ");
	}
}
